...
<task type="auto">
  ...
  <done>
    Message input disabled with "Reconnecting..." placeholder when WS is disconnected. Both MessageComposer and DmComposer are connection-aware. Dead code removed: useAuth.ts (unused orchestration hook) and protocol.ts (unreachable stubs). No dangling imports.
  </done>
</task>
