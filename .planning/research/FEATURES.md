...
| **OAuth / social login** | "Let me log in with Google/Discord" | Adds dependency on external providers. Undermines self-hosted independence. Privacy concern (OAuth providers track logins). | Ed25519 keypair identity with challenge-response auth. Self-contained, no external providers. |
