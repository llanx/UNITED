...
Plans:
- [ ] 03-01: Server libp2p node — gossipsub, relay, AutoNAT, peer directory, message persistence (Wave 1, server)
- [ ] 03-02: Client libp2p node — gossipsub, peer discovery, connection management, IPC integration (Wave 2, client)
- [ ] 03-03: Dev panel — P2P stats IPC pipeline, Zustand store, floating overlay UI with test actions (Wave 3, client)
